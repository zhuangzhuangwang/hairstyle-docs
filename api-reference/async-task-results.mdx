...
<Tab title="cURL">
```bash
curl -X GET "https://www.ailabapi.com/api/common/query-async-task-result?task_id=task_123456789" \
  -H "ailabapi-api-key: YOUR_API_KEY"
```
</Tab>
<Tab title="JavaScript">
```javascript
const taskId = 'task_123456789';

const response = await fetch(`https://www.ailabapi.com/api/common/query-async-task-result?task_id=${taskId}`, {
  method: 'GET',
  headers: {
